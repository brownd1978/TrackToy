...
#nohup time bin/Tracks --process CeMinus --rmue 1e-17 --ntrks 100000 --mustopsfile Mu2eIIa2 --npot 1.3e22 --tfile Mu2e2MCAmbig --trackerfile Data/Mu2e2Tracker.dat --fitschedule Schedule_MCAmbig.txt >& Mu2e2MCAmbigCeM.log &
...
#nohup time bin/Tracks --process CeMinus --rmue 1e-17 --ntrks 100000 --mustopsfile Mu2eIIa2 --npot 1.3e22 --tfile Mu2e2DriftAmbig --trackerfile Data/Mu2e2Tracker.dat --fitschedule Schedule_driftfit.txt >& Mu2e2DriftAmbigCeM.log &
